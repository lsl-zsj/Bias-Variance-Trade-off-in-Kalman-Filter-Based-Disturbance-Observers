...
legend('True','$\eta=\exp(0)$','$\eta=\exp(1)$','$\eta=\exp(2)$','$\eta=\exp(3)$','$\eta=\exp(4)$','$\eta=\exp(20)$','interpreter','latex','fontsize',13)
set(gca,'fontsize',16)
xlabel('time (s)','interpreter','latex')
ylabel('disturbance','interpreter','latex')
xlim([117,143]);
...
set(gcf,'Position',[100 100 700 600]);
legend('$\eta=\exp(0)$','$\eta=\exp(1)$','$\eta=\exp(2)$','$\eta=\exp(3)$','$\eta=\exp(4)$','$\eta=\exp(20)$','interpreter','latex','NumColumns',3)
linkaxes([x1,x2],'x')
set(gcf,'Position',[100 100 700 600]);
xlim([117,143]);
